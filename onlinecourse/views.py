...
def submit(request, course_id):
    ...
    submission.choices.set(Choice.objects.filter(pk__in=choice_ids))
...
def show_exam_result(request, course_id, submission_id):
    ...
    score = get_score(questions, selected_choices)
    max_score = get_max_score(questions)
...
def get_score(questions, selected_choices):
    score = 0
    ...
    for question in questions:
        ...
        if (set(selected_choices_for_question) == set(correct_choices)):
